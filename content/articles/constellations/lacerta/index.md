...
profile_data:
  ...
  "Best Viewed": Summer
  "Hemisphere": Northern
  "Brightest Star": "Stellio (α) Lacertae"
  "Area": 201 sq degrees (68th)

# Taxonomy refs:
dso_caldwell: ["16"]
dso_ngc: ["7209", "7243"]
dso_other: ["Sh 2-126", "IC 1434", "BL Lac", "Abell 79"]
...
Lacerta is one of the "next-generation" constellations: it wasn't included as one of the 48 constellations in Ptolemy's _Almagest_, but was one of the 10 constellations added by Hevelius in 1687, published in 1690 in the _Firmamentum Sobiescienum sive Uranographica_, which also included other minor constellations visible in Northern skies (Canes Venatici, Leo Minor, Lynx, Scutum, Sextans, and Vulpecula), but also three constellations that didn't make the final list by the IAU (Cerberus, Mons Maenalus, and Triangulum Minus).  

{{< nbas-image src="hist_LAC.webp" 
caption="From _Urania's Mirror_, c. 1825" >}}

Hevelius's "lizard" was also originally called "Stellio" after a lizard found in the Mediterranean that shows star-shaped spots.  That name is now sometimes given to Alpha (&alpha;) Lacertae, the brightest star at a meager brightness of 3.76.
...
## Map of Lacerta
{{< nbas-image src="LAC.gif" caption="Map of Lacerta" >}}
...
{{< nbas-image src="ev_lac_finder.webp" width="450" align="right"
caption="EV Lac finder chart with comparison star magnitudes (values x10), AAVSO" >}}
...
src="c_16-92S-PIXRCAGRAXGHS-square.webp"
...
{{< nbas-image src="sh2_126-93T-PIXRCAABEGHS-LP-full-rotated.webp"
caption="Bob Donahue, NBAS, Seestar S30, 69 min" >}}
...
{{< nbas-image src="ngc_7209-92S-PIXRCAGRAXGHS-square.webp"
width="380" align="left"
caption="Bob Donahue, NBAS | Seestar S50, 9 min" >}}
...
{{< nbas-image src="ic_1434-92S-PIXRCAGRAXGHS-square.webp"
width="400" align="left" caption="Bob Donahue, NBAS, Seestar S50, 13 min" >}}
...
{{< nbas-image src="ab_79-93U-PIXRCAABEGHS-square.webp"
width="400" align="right" caption="Bob Donahue, NBAS, eQuinox 2, 37 min" >}}
...
{{< nbas-image src="BL_Lacertae_Pan-STARRS_DR1.webp"
width="320" align="left" caption="PanStarrs DR1" >}}
{{< nbas-image src="BLLacLightCurve.webp" width="500" align="right"
caption="BL Lac light curve, AAVSO" >}}
{{< clear >}}
