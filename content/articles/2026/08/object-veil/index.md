---
title: "The Veil Nebula: One Explosion, Told in Pieces"
date: 2026-08-31
description: "One violent event, 21,000 years old and still glowing: the Veil Nebula is the wreckage of a supernova, split by catalogers into half a dozen pieces."
byline: "A supernova's shockwave, still lighting up the gas it's plowing through, 21,000 years later"
series: ["closer-look"]
authors: ["bob-donahue"]
...
{{< nbas-image src="veil-s30-70m.webp" fullwidth="true" caption="The Veil Nebula complex. Bob Donahue, NBAS, Seestar S30, 70 min." >}}

## Discovery

{{< nbas-image src="herschel.webp" align="right" width="250"
...
{{< nbas-image src="fleming.webp" align="left" width="250"
caption="Williamina Fleming, c. 1890s" >}}
...
{{< nbas-image src="veil-s30-annotated.webp" fullwidth="true" caption="The same image, annotated. The whole structure is one supernova shockwave, the Cygnus Loop; every label here is a cataloguer's boundary, not a separate object." >}}

{{< nbas-image src="c33-20240714-72m.webp" fullwidth="true" caption="A closer look at one piece of the puzzle: the Eastern Veil (Caldwell 33 -- NGC 6992, NGC 6995, and IC 1340). Bob Donahue, NBAS, Unistellar eQuinox2, 72 min." >}}
...
{{< nbas-image src="c34-20240702-68m.webp" fullwidth="true" caption="NGC 6960 (Caldwell 34, the Western Veil), showing the same blue-to-red transition -- fresh shock along the leading edge, cooling to red behind it. The bright star is 52 Cygni, with the filament passing right beside it. Bob Donahue, NBAS, Unistellar eQuinox2, 68 min." >}}
...
{{< nbas-image src="cygnus-loop-3d-model.webp" fullwidth="true" link="https://chandra.harvard.edu/deadstar/cygnus.html" caption="A 3D simulation of the blast wave hitting an isolated cloud of interstellar gas -- the same kind of encounter happening, at different densities and angles, all across the Veil. Click through for Chandra's video and a downloadable 3D-printable model of this structure. Credit: INAF-Osservatorio Astronomico di Palermo/Salvatore Orlando." >}}
...
{{< nbas-gallery style="grid" title="Other Supernova Remnants" size="280px" >}}
m_1-92U-PIXRCAGRAXGHS-square.webp | M1, the Crab Nebula (Taurus) |
ic_443-92U-PIXRCADBEGHS-full.webp | IC 443, the Jellyfish Nebula (Gemini) |
{{< /nbas-gallery >}}
