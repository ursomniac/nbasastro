---
title: "Gliese 710: The Closest Stellar Approach — Ever?"
date: 2026-08-03
authors: ["bob-donahue"]
...
object_info:
  ...
  mass: "~0.60 M☉"
  luminosity: "~0.037 L☉"
  closest_approach: "0.170 ly (~10,635 AU)"
  approach_time: "~1.29 million years"
---
...
{{< nbas-image src="comparison.svg" size="450" align="right"
caption="Size and color comparison of the Sun (G2 V, left) and Gliese 710 (K7 V, right). Gliese 710 is cooler, smaller, and distinctly orange — emitting roughly 4% of the Sun's luminosity." >}}
...
{{< nbas-image src="gliese-710-velocity.svg" caption="A star's full three-dimensional space velocity is the combination of its transverse velocity (derived from proper motion × distance) and its radial velocity (measured from the Doppler shift of its spectrum). For Gliese 710, the transverse component is nearly zero — almost all of its motion is along the line of sight." >}}
...
{{< nbas-image src="gliese-710-full.svg" caption="Gliese 710's distance from the Sun over a two million year window. The star is currently 63.8 light-years away and will reach perihelion of 0.170 ly (~10,635 AU) in approximately 1.29 million years before receding again." >}}
...
{{< nbas-image src="gliese-710-closeup.svg" caption="Gliese 710's trajectory through the inner Oort Cloud. The star crosses the 1.5 light-year boundary at roughly 1.26 and 1.33 million years from now, spending approximately 70,000 years inside that threshold before reaching perihelion." >}}
...
{{< nbas-image src="gliese-710-histogram.svg"
caption="Probability distribution of Gliese 710's closest approach distance, based on 10,000 Monte Carlo N-body simulations using Gaia DR3 astrometry. Median 0.052 pc (~10,635 AU); 90% probability of coming within 0.048–0.056 pc. Blue line: median; red lines: 5th and 95th percentiles. Source: de la Fuente Marcos &amp; de la Fuente Marcos (2022)." >}}
