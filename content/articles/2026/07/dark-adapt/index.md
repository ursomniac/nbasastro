...
{{< nbas-image src="rod-cone-density.svg" align="right" width="460"
caption="Rod and cone density across the retina. The fovea — the point you're looking directly at — is packed with cones but has almost no rods. The rod-rich zone peaks about 15–20° away from center." >}}
...
{{< nbas-image src="dark-adaptation-curve.svg" align="right" width="460"
caption="The two-phase dark adaptation curve. Cones adapt first (within about 7 minutes) but reach a modest ceiling. Rods continue improving for 30 minutes or more, ultimately reaching sensitivity roughly 100× greater than cones in the dark." >}}
...
{{< nbas-image src="spectral-sensitivity.svg" align="right" width="460"
caption="Rods (blue curve) and cones (yellow) respond differently to different wavelengths. Rods are almost completely insensitive to deep red light above about 640nm — which is why astronomers use red torches." >}}
...
{{< nbas-image align="left" width="350" src="using_telescope.jpg"
caption="LassenNPS, Public domain, via Wikimedia Commons" >}}
...
{{< nbas-image src="averted-vision.svg" align="center" width="480"
caption="Direct gaze places the faint object on the cone-rich fovea, where it may be invisible. Shifting your gaze 10–15° to the side moves the object onto the rod-rich periphery — and it appears." >}}
...
{{< nbas-image src="pupil-size.svg" align="right" width="460"
caption="Maximum dark-adapted pupil diameter declines steadily from roughly 7–8mm in youth to about 4mm by age 70. This has direct consequences for low-magnification telescope use." >}}
