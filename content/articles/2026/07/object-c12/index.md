...
date: 2026-07-27
description: "NGC 6946 has produced 10 confirmed supernovae since 1917: more than any other known galaxy. One of those stars didn't even bother to explode. It just vanished."
byline: "Ten supernovae, one vanishing act, and a star-forming machine in the summer sky"
series: ["closer-look"]
...
object_info:
  ...
  coordinates:
    ...
    - "Dec +60° 09′ 13″"
  magnitude: "9.0"
  angular_size: "11.6′ × 9.8′"
  morphological_type: "SAB(rs)cd"
  distance: "~22 Mly"
...
One of those stars didn't explode at all. It was catalogued, measured, and watched — and then it simply wasn't there anymore. What happened to it is one of the most intriguing unsolved questions in stellar physics.
...
{{< nbas-image src="c_12-92U-40m.jpg" fullwidth="true"
caption="NGC 6946. Bob Donahue, NBAS, eQuinox 2, 40 min" >}}
...
| SN 2008S | 2008 | Uncertain | Possibly not a true supernova — an intermediate luminosity transient |
...
In the outer reaches of one of NGC 6946's spiral arms sat a red supergiant catalogued as N6946-BH1. It was a massive star — roughly 25 times the mass of the Sun — which made it a prime supernova candidate. Astronomers monitoring it with Hubble watched its luminosity increase dramatically in early 2009, then fade. By 2015, it was gone. Not dimmed — gone. Optical observations found nothing where the star had been, replaced only by a faint infrared glow.

{{< nbas-image src="bh1-nasa.jpg" fullwidth="true"
caption="N6946-BH1 in 2007 (left, Hubble WFPC2) and 2015 (right, Hubble WFC3). The star visible in the left frame is simply gone in the right frame — replaced by nothing detectable in optical wavelengths. NASA / ESA / Hubble Space Telescope" >}}

The leading explanation is a *failed supernova*: a stellar collapse so rapid and complete that the star fell directly into a black hole without producing the shock wave that drives a normal supernova explosion. In the standard picture, when a massive star's iron core collapses, the resulting supernova explosion is driven by a flood of neutrinos. In some cases — particularly for very massive stars — the core may collapse too quickly for that mechanism to launch the envelope outward. The star simply implodes. The energy that would have powered the explosion is instead carried away by neutrinos, and the outer layers of the star fall in behind, leaving nothing but a black hole and a brief, fading infrared glow from the disrupted envelope.

This had been predicted theoretically. N6946-BH1 is one of the best observational candidates ever found for the phenomenon. It isn't confirmed — alternative explanations have been proposed, including the possibility that the star merged with a companion and is now hidden inside a dust shell — but the failed supernova interpretation remains the leading one.
