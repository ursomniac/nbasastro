...
**Magnification claims on the box.** Reputable telescopes are marketed by aperture. A box that leads with "675× POWER!" or "See 1,000,000 miles!" is targeting impulse buyers, not astronomers. Maximum useful magnification is a function of aperture — around 50× per inch — and no telescope delivers useful views at the numbers typically advertised on department store boxes.
...
The used market for telescopes is genuinely excellent and worth exploring, particularly for mid-range and higher-end instruments. Telescopes are durable, hold their value reasonably well, and are often sold by people upgrading rather than abandoning the hobby — which means the equipment is usually in good condition and was used by someone who cared about it.

Good places to find used equipment:

- **CloudyNights Classified Ads** (cloudynights.com) — the largest dedicated astronomy classifieds, well-moderated
- **Astromart** (astromart.com) — long-established, reputable
- **Local astronomy clubs** — members often sell equipment directly, and you can inspect it in person
- **Facebook Marketplace and Craigslist** — more variable quality and sellers, but deals exist

**One caution about used purchases:** it's easy to acquire a complete setup — telescope, mount, multiple eyepieces, filters, accessories, cases — and feel immediately overwhelmed. A full astrophotography rig that someone spent years building and learning to use doesn't become intuitive just because you own it. If you're a complete beginner, a single good used telescope with a couple of eyepieces is a better starting point than an entire system you don't yet know how to operate. You don't have to use everything that comes with a purchase. Set aside what you don't understand yet and come back to it.
...
- **Mount:** Test the motion — it should move smoothly with no grinding or binding. Check that locks work.
...
- Moon and planets → refractor or Cassegrain, good mount, quality eyepieces
- Deep sky objects → Dobsonian for maximum aperture, or smart scope
- Everything → 6–8" SCT on an equatorial mount, or a smart scope as a starting point
- Convenience and sharing → smart scope

**How portable does it need to be?**
- Travels in a car trunk, sets up in the backyard → most scopes work
- Carries on a plane or hiking → small refractor, tabletop Dob, or compact smart scope
- Never moves, permanent setup → any size, prioritize aperture and mount quality

**What's your budget?**
- Under $300 → small Dobsonian or entry smart scope; don't compromise on quality
- $300–600 → good 6" Dob, decent refractor on an alt-az, or entry smart scope
- $600–1,200 → 8" Dob, 6" SCT, or mid-range smart scope
- $1,200+ → serious equatorial setups, premium smart scopes, astrophotography rigs

**How much complexity can you handle on day one?**
- Minimal → smart scope, GoTo alt-az, or Dobsonian
- Some → equatorial with motor drive
- Enthusiastic learner → any of the above; the complexity is learnable
